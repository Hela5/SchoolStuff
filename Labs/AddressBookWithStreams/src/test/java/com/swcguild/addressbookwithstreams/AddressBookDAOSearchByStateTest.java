 ...
 * @author apprentice
 */
public class AddressBookDAOSearchByStateTest {
    ...
    public AddressBookDAOSearchByStateTest() {
    }
    ...
    @Test
    public void searchByNullStateTest() {
        ...
        Map result = dao.searchByState(state);

        assertEquals(0, result.size());
    }

    @Test
    public void searchByBadNameStateTest() {
        dao = new AddressBookDAOFileImpl();
        dao.addAddress(a1);
        dao.addAddress(a2);
    ...
    @Test
    public void searchByStateMultiplesTest() {
        dao = new AddressBookDAOFileImpl();
        dao.addAddress(a1);
        dao.addAddress(a2);
        dao.addAddress(a3);
