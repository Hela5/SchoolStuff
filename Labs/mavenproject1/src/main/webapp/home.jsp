        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation"><a href="${pageContext.request.contextPath}/editDVDForm">Edit</a></li>
                    <li role="presentation"><a href="${pageContext.request.contextPath}/newDVDForm">New DVD Entry</a></li>
