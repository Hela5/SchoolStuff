 ...
 * @author apprentice
 */
public class DVDLibraryDAOFindAllReleasedByStudioTest {
    ...
    public DVDLibraryDAOFindAllReleasedByStudioTest() {
    }
    ...
    @Test
    public void findAllReleasedByNullStudioTest() {
        ...
        String studio = null;
        List result = dao.findAllReleasedByStudio(studio);
        assertEquals(0, result.size());

    }

    @Test
    public void findAllReleasedByRegStudioTest() {
        dao = new DVDLibraryDAOFileImpl();
        dao.addDVD(d1);

        String studio = "Their house";
        List result = dao.findAllReleasedByStudio(studio);
        ...
        dao.addDVD(d3);
        studio = "Hollywood";
        result = dao.findAllReleasedByStudio(studio);
