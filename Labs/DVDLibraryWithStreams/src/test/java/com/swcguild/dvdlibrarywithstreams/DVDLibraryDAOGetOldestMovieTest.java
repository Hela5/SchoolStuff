 ...
 * @author apprentice
 */
public class DVDLibraryDAOGetOldestMovieTest {
    ...
    public DVDLibraryDAOGetOldestMovieTest() {
    }
    ...
    public void getOldestMovieTest() {
        ...
        dao.addDVD(d1);
        List result = dao.getOldestMovie();
        assertEquals(1, result.size());

        dao.addDVD(d2);
        dao.addDVD(d3);
        result = dao.getOldestMovie();
        assertEquals(2, result.size());
    }

    
//    @Test
//    public void getOldestNullMovieTest() {
//        dao = new DVDLibraryDAOFileImpl();
//        
//        DVD d4 = new DVD();
//        dao.addDVD(d4);
