 ...
 * @author apprentice
 */
public class DVDLibraryDAOFindAllMoviesWithRatingTest {
    ...
    public DVDLibraryDAOFindAllMoviesWithRatingTest() {
    }
    ...
    @Test
    public void findMoviesWithNullRatingTest() {
        ...
        List result = dao.findAllMoviesWithRating(rating);
        assertEquals(0, result.size());

    }

    @Test
    public void findMoviesWithRegularRatingTest() {
        dao = new DVDLibraryDAOFileImpl();
        dao.addDVD(d1);
        dao.addDVD(d2);
        dao.addDVD(d3);
